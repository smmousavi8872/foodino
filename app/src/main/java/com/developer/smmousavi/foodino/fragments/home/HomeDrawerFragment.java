...
import com.developer.smmousavi.foodino.activities.drawer.OnBackPressedListener;
import com.developer.smmousavi.foodino.activities.drawer.SetOnContentFragmentInsert;
...
import com.developer.smmousavi.foodino.fragments.chatbottomsheet.OnChatCloseClickListener;
...
public class HomeDrawerFragment extends BaseDaggerFragment implements OnBackPressedListener, OnChatCloseClickListener {
    ...
    private void subscribeObservers() {
        mViewModel.searchPreviewRecipes("beef", 1);
        mViewModel.getPreviewRecipesLd().observe(this, recipes -> {
            if (recipes != null) {
                List<Recipe> subRecipes = recipes.subList(0, 9);
                setSpecialOfferProductPreviewRv(subRecipes);
            }
        });
    }
