package com.developer.smmousavi.foodino.viewholders.shoppingbasket;
...
import com.developer.smmousavi.foodino.util.ImageUtils;
...
public class ShoppingBasketSuggestionsVH<T extends Recipe> extends BaseViewHolder<T> implements View.OnLongClickListener {
    ...
    public ShoppingBasketSuggestionsVH(@NonNull View itemView) {
        super(itemView);
        mItemView = itemView;
    ...
    public void bind(Recipe recipe) {
        mProduct = recipe;
        ImageUtils.loadImage(recipe.getImageUrl(), mImgProductPreviewImage);
