...
import com.developer.smmousavi.foodino.fragments.alertdialog.AlertDialogFragment;
import com.developer.smmousavi.foodino.fragments.alertdialog.OnDialogButtonClickListener;
...
public class ShoppingBasketFragment extends BaseDaggerFragment implements
    ...
    private List<Product> mProductSuggestionList;
    ...
    public void subscribeObservers() {
        mViewModel.getSuggestedRecipes("cookie", 1);
        mViewModel.getRecipeLd().observe(this, recipes -> {
            if (recipes != null)
                setProductsSuggestionsRv(recipes.subList(0, 9));
        });
    }
    ...
    protected void setProductsSuggestionsRv(List<Recipe> recipes) {
        ...
        mProductSuggestionsRvAdapter.notifyDataSetChanged();
        /*
